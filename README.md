...
## Профиль  
Backend-разработчик (Go/Python) с опытом проектирования отказоустойчивых распределенных систем. Умею ускорять работу сервисов, оптимизировать базы данных и внедрять Event-Driven подходы. 
