...
### 2025 — Fullstack Developer, ИП Петров Эдуард  
**Стек:** FastAPI, React, Elasticsearch, Docker, GitHub Actions, Nginx  
- Поиск и фильтрация товаров через Elasticsearch  
- Авторизация (JWT, OAuth2)  
- Автоматизация деплоя через CI/CD  

### 2024 — Python Developer, ИП Тыченко Тимур  
**Стек:** FastAPI, Go, Redis, MongoDB  
- Перевод монолита в микросервисы  
- Оптимизация асинхронных процессов  
- Поиск лидов через Telegram-интерфейсы  

### 2023 — Python Developer, WoW Top  
**Стек:** Django DRF, PostgreSQL  
- Разработка ПО для менеджмента продаж на WildBerries  
- Рост эффективности штата на 50%  

### 2023 — Фриланс, KWORK  
**Стек:** Python, Telegram API  
- Telegram-боты  
- Консалтинг и работа с клиентами напрямую  
